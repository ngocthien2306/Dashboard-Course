package com.chap7ex0102.download;
...
import com.chap7ex0102.data.*;
import com.chap7ex0102.util.CookieUtil;

@WebServlet(urlPatterns = "/_chap7ex0102/download")
public class DownloadServlet extends HttpServlet {
    ...
    private String checkUser(HttpServletRequest request,
        ...
        String productPath = sc.getRealPath("/WEB-INF/download/products.txt");
        ...
        if (user == null) {
            ...
            // if cookie exists, create User object and go to Downloads page
                ...
                String path = sc.getRealPath("/WEB-INF/download/EmailList.txt");
